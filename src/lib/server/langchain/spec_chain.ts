...
import { z } from 'zod';
import { createStructuredOutputChainFromZod } from 'langchain/dist/chains/openai_functions';
...
const svelteComponentScheme: z.ZodType<SvelteComponentsScheme> = baseSvelteComponentScheme.extend({
